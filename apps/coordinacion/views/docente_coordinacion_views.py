...
from apps.coordinacion.models import DocenteAsesor, PracticaEmpresarial, SeguimientoSemanal
from apps.coordinacion.forms import DocenteAsesorForm
from apps.core.decorators import coordinator_required
