...
from apps.coordinacion.models import DocenteAsesor, PracticaEmpresarial, SeguimientoSemanal, Estudiante
...
def perfil_docente(request):
    ...
    from apps.docente.forms import DocenteAsesorPerfilForm
